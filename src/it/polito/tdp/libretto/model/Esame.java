 ...
 * costruttore
 * metodi get / set
 * medoti di servizio(equals, toString, compareTo, hasCode, [ect])
 *
 * 
...
//	private Docente docente; // soluzione giusta
	...
	public boolean equals(Object obj) {
		...
		if (codice == null) {
			if (other.codice != null)
				return false;
		} else if (!codice.equals(other.codice)) // quello che è importante
			return false;
		return true;
	}
	/**
	 * Se l'esame non è ancora superato, lo considero superato con il voto e la data specificati.
